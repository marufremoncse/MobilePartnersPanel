...
class PieChartControllerFeature extends Controller
{
    public function getYearlyDivisionFeatureMobileCount(Request $request){
    ...
    public function getPreviousYearlyDivisionFeatureMobileCount(Request $request){
        if ($request->model == "all_models") {
            $all_division = array("Dhaka"=>"Dhaka","Chittagong"=>"Chittagong",
                "Rajshahi"=>"Rajshahi","Khulna"=>"Khulna",
                "Rangpur"=>"Rangpur","Barisal"=>"Barisal",
    ...
    public function getCurrentMonthDivisionFeatureMobileCount(Request $request){
        if ($request->model == "all_models") {
            $all_division = array("Dhaka"=>"Dhaka","Chittagong"=>"Chittagong",
                "Rajshahi"=>"Rajshahi","Khulna"=>"Khulna",
                "Rangpur"=>"Rangpur","Barisal"=>"Barisal",
    ...
    public function getPreviousMonthDivisionFeatureMobileCount(Request $request){
        if ($request->model == "all_models") {
            $all_division = array("Dhaka"=>"Dhaka","Chittagong"=>"Chittagong",
                "Rajshahi"=>"Rajshahi","Khulna"=>"Khulna",
                "Rangpur"=>"Rangpur","Barisal"=>"Barisal",
