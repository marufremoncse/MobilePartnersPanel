$(function () {
    ...
    var charts_pie_feature = {
        ...
        ajaxGetData: function (sent_url, model) {
            ...
            request.done(function (response) {
                charts_pie_feature.createCompletedPieChartFeature(response);
            });
        },

        createCompletedPieChartFeature: function (response) {
            ...
            var pieChartCanvas = $('#pieChartFeature').get(0).getContext('2d');
    ...
    var sent_url = "pieChartCurrentMonthDivisionFeature";
    var model = "all_models";
    charts_pie_feature.init(sent_url,model);
  /*  console.log('http://127.0.0.1:8000/' + sent_url + '/' + model);*/


    $(document).ready(function() {
        $("#PieChartID_feature").change(function(){

            model = "all_models";
            sent_url = $('#PieChartID_feature option:selected').val();
            /*console.log('http://127.0.0.1:8000/' + sent_url + '/' + model);*/

            $('#refresh_main_feature').load('activation #refresh_feature', function() {
