...
(function(phantom){
    ...
    function debugPage(){
        console.log("Refresh a second debugger-port page and open a second webkit inspector for the projection page.");
        console.log("Letting this page continue will then trigger a break in the projection page.");
