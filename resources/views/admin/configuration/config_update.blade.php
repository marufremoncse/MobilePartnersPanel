        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <!-- form start -->
                        <form action="{{route('config.update',$table_all->id)}}" method="post"
                                    ...
                                    <div class="form-group   ">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="org_id" name="org_id" value="{{$table_all->organization_id}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="btrc" name="btrc" value="{{$table_all->btrc_share}}"
                                    ...
                                    <div class="form-group   ">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="gp_share" name="gp_share" value="{{$table_all->gp_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="airtel_share" name="airtel_share" value="{{$table_all->airtel_share}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="robi_share" name="robi_share" value="{{$table_all->robi_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="bl_share" name="bl_share" value="{{$table_all->bl_share}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="teletalk_share" name="teletalk_share" value="{{$table_all->teletalk_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="discrepancy" name="discrepancy" value="{{$table_all->discrepancy}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="ait" name="ait" value="{{$table_all->ait}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="billing_fee" name="billing_fee" value="{{$table_all->billing_fee}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="partner_share" name="partner_share" value="{{$table_all->partner_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="vat" name="vat" value="{{$table_all->vat}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="gp_grand_share" name="gp_grand_share" value="{{$table_all->gp_grand_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="airtel_grand_share" name="airtel_grand_share" value="{{$table_all->airtel_grand_share}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="robi_grand_share" name="robi_grand_share" value="{{$table_all->robi_grand_share}}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="bl_grand_share" name="bl_grand_share" value="{{$table_all->bl_grand_share}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="teletalk_grand_share" name="teletalk_grand_share" value="{{$table_all->teletalk_grand_share}}"
