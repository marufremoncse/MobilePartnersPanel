                                    ...
                                    <div class="form-group   ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                            class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="slug" name="slug" value="{{$role->slug}}"
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select class="form-control select2" id="for_all_select"
                                                    ...
                                                    @foreach($permission_all as $permission)
                                                        <option value="{{$permission->id}}" @foreach($permission_already_selected as $selected)
                                                            {{$permission->id == $selected  ? 'selected' : ''}}
