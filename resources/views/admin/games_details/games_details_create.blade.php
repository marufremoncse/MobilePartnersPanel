        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <!-- form start -->
                        <form action="{{route('games-details.store')}}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                                class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text" id="sub_keyword" name="sub_keyword" value=""
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="game_provider" list="game_provider_data_list"
                                                       class="form-control name" placeholder="Game Provider"/>
