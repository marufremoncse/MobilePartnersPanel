            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('permission.update',$permission->id)}}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                        @csrf
                            {{method_field('PUT')}}
                                ...
                                <div class="fields-group">
                                    <div class="form-group   ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text"   id="name" name="name" value="{{$permission->name}}" class="form-control name" placeholder="Name" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group   ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                                <input type="text"   id="slug" name="slug" value="{{$permission->slug}}" class="form-control slug" placeholder="Slug" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control input-sm http_uri"  id="http" data-placeholder="HTTP method" style="width: 100%;" name="http" >
                                                @foreach($route_all as $route)
                                                    <option value="{{$route->id}}"  {{$route->id==$permission->http? 'selected':''}}>{{$route->method}} {{' :: '}}{{$route->http}}</option>
                                                @endforeach
