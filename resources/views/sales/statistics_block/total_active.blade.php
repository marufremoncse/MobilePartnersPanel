                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <form action="{{route('active')}}" method="post" id="sales_search">
                                    @csrf
                                    {{method_field('get')}}
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right col-sm-2">
                                <span class="form-control btn-danger">{{--{{date("M-y")." : "}}--}}This Month:
                                    {{$current_month_activation->count}}</span>
                            </div>

                            <div class="pull-right col-sm-2">
                                <span class="form-control btn-success">{{--{{date("d-M-y")." : "}} --}}Today: {{$todays_activation->count}}</span>
                            </div>
