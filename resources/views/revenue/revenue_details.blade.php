                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <form action="{{url('/revenue/report')}}" method="post" id="active_search">
                                    @csrf
                                    {{method_field('get')}}
                                    ...
                                    <div class="modal-body" style="width: 100%;">
                                        ...
                                        <div class="rTable">
                                            ...
                                            <div class="rTableRow">
                                                ...
                                                <div class="rTableCell">{{$base = 40}}</div>
                                                <div class="rTableCell">{{$btrc = round($base - $base*$share_details->btrc_share,2)}}</div>
                                                <div class="rTableCell">{{$telco = round($btrc - $btrc*$share_details->robi_share,2)}}</div>
                                                <div class="rTableCell">{{$discrepancy = round($telco - $telco*$share_details->discrepancy,2)}}</div>
                                                <div class="rTableCell">{{$ait = round($discrepancy - $discrepancy*$share_details->ait,2)}}</div>
                                                <div class="rTableCell">{{$billing_fee = round($ait - $ait*$share_details->billing_fee,2)}}</div>
                                                <div class="rTableCell">{{$partner_share = round($billing_fee*$share_details->partner_share,2)}}</div>
                                        ...
                                        <div class="rTable">
                                            ...
                                            <div class="rTableRow">
                                                ...
                                                <div class="rTableCell">{{$base = 40}}</div>
                                                <div class="rTableCell">{{$btrc = round($base - $base*$share_details->btrc_share,2)}}</div>
                                                <div class="rTableCell">{{$telco = round($btrc - $btrc*$share_details->teletalk_share,2)}}</div>
                                                <div class="rTableCell">{{$discrepancy = round($telco - $telco*$share_details->discrepancy,2)}}</div>
                                                <div class="rTableCell">{{$ait = round($discrepancy - $discrepancy*$share_details->ait,2)}}</div>
                                                <div class="rTableCell">{{$billing_fee = round($ait - $ait*$share_details->billing_fee,2)}}</div>
                                                <div class="rTableCell">{{$partner_share = round($billing_fee*$share_details->partner_share,2)}}</div>
                        ...
                        <div class="box-header with-border">
                            ...
                            <form action="{{url('/revenue/report')}}" method="post">
                                @csrf
                                {{method_field("get")}}
                            ...
                            <div class="col-sm-3">
                                <span class="form-control btn-success">{{--{{date("d-M-y")." : "}} --}}Today's Revenue: @isset($todays_revenue->day_wise_revenue){{$todays_revenue->day_wise_revenue}}@endisset</span>
                            </div>
                                            ...
                                            <div class="modal-dialog" style="width: 70%;">
                                                ...
                                                <div class="modal-content" style="width: 100%;">
                                                    ...
                                                    <div class="modal-body" style="width: 100%;">
                                                        <div class="rTable">
                                                            <div class="rTableRow">
                                                                <div class="rTableHead">User Charged</div>
