...
@section('content')
    ...
    <div id="app">
        <section class="content-header">
            <h1>
                <i class="fa fa-indent" aria-hidden="true"></i> Game: {{$page_name}}
                <small></small>
            </h1>
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <form action="{{url('/revenue/total-game/'.$page_name)}}" method="post"
                                      id="active_search">
                                    @csrf
                                    {{method_field('get')}}
                                    ...
                                    <div class="modal-body" style="width: 100%;">
                                        <div class="rTable">
                                            ...
                                            <div class="rTableRow">
                                                ...
                                                <div
                                                        class="rTableCell">{{$telco = round($btrc - $btrc*$share_details->gp_share,2)}}</div>
                                                <div
                                        ...
                                        <div class="rTable">
                                            ...
                                            <div class="rTableRow">
                                                ...
                                                <div
                                                        class="rTableCell">{{$btrc = round($base - $base*$share_details->btrc_share,2)}}</div>
                                                <div
                                                        class="rTableCell">{{$telco = round($btrc - $btrc*$share_details->bl_share,2)}}</div>
                                                <div
                                                        class="rTableCell">{{$discrepancy = round($telco - $telco*$share_details->discrepancy,2)}}</div>
                                                <div
                                                        class="rTableCell">{{$ait = round($discrepancy - $discrepancy*$share_details->ait,2)}}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="btn-group pull-left">
                                    <form action="{{url('/revenue/total-game/'.$page_name)}}" method="post">
                                        ...
                                        <button onclick="datepicker_caller()" type="submit"
                                                class="btn btn-flat btn-primary">Apply
                                        </button>
                                    </form>
                                </div>
                            </div>
                                                    ...
                                                    <div class="modal-body" style="width: 100%;">
                                                        <div class="rTable">
                                                            <div class="rTableRow">
                                                                ...
                                                                <div class="rTableHead">After BTRC Share
                                                                    <br>of {{$share_details->btrc_share*100}}%
                                                                </div>
                                                                <div class="rTableHead">After {{$all->operator}} Share
                                                                    <br>of {{$telco_share*100}}%
                                                                </div>
                                                                <div class="rTableHead">After Discrepancy
                                                                    <br>of {{$share_details->discrepancy*100}}%
                                                                </div>
                                                                <div class="rTableHead">After AIT
                                                                    <br>of {{$share_details->ait*100}}%
                                                                </div>
                                                                <div class="rTableHead">After Billing Fee
                                                                    <br>of {{$share_details->billing_fee*100}}%
                                                                </div>
                                                                <div class="rTableHead">{{$oem_name->oem}} Share
                                                                    <br>of {{$share_details->partner_share*100}}%
                                                                </div>
                                                                <div class="rTableHead">After VAT
                                                                    <br>of {{$share_details->vat*100}}%
                                                                </div>
                                                            </div>
                                                            <div class="rTableRow">
                                                                <div
                                                                        class="rTableCell">{{round($charged_amount,2)}}</div>
                                                                <div class="rTableCell">{{round($after_btrc,2)}}</div>
                                                                <div class="rTableCell">{{round($after_telco,2)}}</div>
                                                                <div
                                                                        class="rTableCell">{{round($after_discrepancy,2)}}</div>
                                                                <div class="rTableCell">{{round($after_ait,2)}}</div>
                                                                <div
                                                                        class="rTableCell">{{round($after_billing_fee,2)}}</div>
                                                                <div
                                                                        class="rTableCell">{{round($partner_share,2)}}</div>
