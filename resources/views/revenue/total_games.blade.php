                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <form action="{{url('/revenue/total-game')}}" method="post" id="active_search">
                                    @csrf
                                    {{method_field('get')}}
                        ...
                        <div class="box-header with-border">
                            ...
                            <form action="{{url('/revenue/total-game')}}" method="post">
                                @csrf
                                {{method_field("get")}}
                                ...
                                <div class="btn-group pull-left">
                                    <div class="form-group">
                                        <select class="form-control" id="order_sort" name="sort_select">
                                            ...
                                            <option value="monthly_revenue,desc">Revenue desc</option>
                                            <option value="monthly_revenue,asc">Revenue asc</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($table_all as $all)
                                        <tr>
                                            ...
                                            <td>{{$all->monthly_revenue}}</td>
                                            <td><a href="{{url('/revenue/total-game/'.$all->game_name)}}"><span title="details" type="button" class="btn btn-primary" style="border-radius: 30%"><i style="font-size:larger;" class="fa fa-info-circle"></i></span></a>&nbsp;</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
